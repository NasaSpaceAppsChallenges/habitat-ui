    ...
    return {
      ...
      response: {
        ...
        images: [
          ...
          {
            base64: "iVBORw0KGgoAAAANSUhEUgAABAAAAAYACAIAAABn4K39AAEvD",
            name: "2.png"
          }
        ],
        worsePoints: [
          {
            moduleType: "full_hygiene_station",
            withModuleType: "common_kitchen_and_mess",
            points: -15,
            reason: "Distância excessiva entre higienização e preparo dos alimentos compromete a rotina da tripulação.",
          },
        ],
        improvementPoints: [
          {
            moduleType: "radiation_shelter",
            withModuleType: "work_command_station",
            points: -10,
            reason: "Blindagem insuficiente próxima ao centro de comando durante tempestades solares simuladas.",
          },
        ],
        insights: {
          negative: [
            {
              ...
              withModuleType: "common_kitchen_and_mess",
              points: -12,
              reason: "Risco de contaminação cruzada detectado na análise automatizada.",
            },
          ],
          positive: [],
        },
